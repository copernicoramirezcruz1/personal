...
<template>
  <section id="projects" class="relative py-24 md:py-32 overflow-hidden">
    <div class="absolute top-0 left-1/3 w-96 h-96 bg-amber-500/5 rounded-full blur-[128px]" />
    <div class="absolute bottom-0 right-1/3 w-96 h-96 bg-orange-500/5 rounded-full blur-[128px]" />
