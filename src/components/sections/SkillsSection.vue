...
<template>
  <section id="skills" class="relative py-24 md:py-32 overflow-hidden">
    <div class="absolute bottom-0 left-1/4 w-96 h-96 bg-orange-500/5 rounded-full blur-[128px]" />
    ...
    <div class="section-container relative z-10">
      ...
      <div class="grid md:grid-cols-2 gap-8 md:gap-12">
        <div class="space-y-2">
          <span class="text-xs font-mono tracking-widest text-amber-400 uppercase reveal">
