...
<template>
  <div
    class="group relative rounded-2xl overflow-hidden glass card-hover reveal"
  ...
  >
    ...
    <div class="relative p-6 md:p-8">
      ...
      <p class="text-zinc-400 leading-relaxed mb-5 line-clamp-3">
        {{ description }}
      </p>
      ...
      <div class="flex flex-wrap gap-2 mb-6">
        <span
          ...
          :key="tech"
          class="text-xs font-mono px-2.5 py-1 rounded-lg bg-zinc-800/80 text-zinc-400 border border-zinc-700/50"
        >
          {{ tech }}
        </span>
      </div>
      ...
      <div class="flex items-center gap-4">
        <a :href="link" class="btn-primary text-sm !py-2 !px-4">
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
          Ver Demo
        </a>
        <a :href="github" class="btn-secondary text-sm !py-2 !px-4">
